...
public class level5 extends AppCompatActivity {
    ...
    {
        BottomSheetDialog bottomSheetDialog = new BottomSheetDialog(level5.this);
    ...
    private void getquizquestion (ArrayList < quizmodel > quizmodelArrayList) {
        quizmodelArrayList.add(new quizmodel("8 + ___", "10", "12", "14", "16", "14"));
        quizmodelArrayList.add(new quizmodel("4 + ___", "8", "6", "9", "10", "8"));
        quizmodelArrayList.add(new quizmodel("9 + ___", "12", "11", "13", "10", "11"));
        quizmodelArrayList.add(new quizmodel("6 + ___", "10", "11", "12", "13", "11"));
        quizmodelArrayList.add(new quizmodel("1 + ___ ", "10", "11", "9", "12", "9"));
        quizmodelArrayList.add(new quizmodel("3 + ___", "9", "11", "13", "15", "9"));
        quizmodelArrayList.add(new quizmodel("6 + ___", "9", "13", "12", "10", "10"));
        quizmodelArrayList.add(new quizmodel("7 + ___", "11", "13", "14", "12", "12"));
        quizmodelArrayList.add(new quizmodel("8 + ___", "17", "16", "18", "15", "17"));
        quizmodelArrayList.add(new quizmodel("8 + ___", "15", "17", "16", "18", "16"));
    }
