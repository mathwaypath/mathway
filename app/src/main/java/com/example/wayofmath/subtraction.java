...
public class subtraction extends AppCompatActivity {
    ...
    {
        BottomSheetDialog bottomSheetDialog = new BottomSheetDialog(subtraction.this);
    ...
    private void getquizquestion (ArrayList < quizmodel > quizmodelArrayList) {
        quizmodelArrayList.add(new quizmodel("10 - 2", "8", "6", "7", "9", "8"));
        quizmodelArrayList.add(new quizmodel("8 - 4", "5", "6", "3", "4", "4"));
        quizmodelArrayList.add(new quizmodel("7 - 3", "5", "4", "6", "3", "4"));
        quizmodelArrayList.add(new quizmodel("9 - 2", "8", "6", "7", "5", "7"));
        quizmodelArrayList.add(new quizmodel("4 - 1 ", "3", "2", "5", "1", "3"));
        quizmodelArrayList.add(new quizmodel("5 - 2", "2", "3", "4", "1", "3"));
        quizmodelArrayList.add(new quizmodel("6 - 4", "4", "5", "2", "3", "2"));
        quizmodelArrayList.add(new quizmodel("2 - 1", "1", "0", "3", "2", "1"));
        quizmodelArrayList.add(new quizmodel("8 - 8", "0", "1", "2", "3", "0"));
        quizmodelArrayList.add(new quizmodel("9 - 7", "3", "2", "4", "5", "2"));
    }
