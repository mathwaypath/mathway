...
public class division extends AppCompatActivity {
    ...
    {
        BottomSheetDialog bottomSheetDialog = new BottomSheetDialog(division.this);
    ...
    private void getquizquestion (ArrayList < quizmodel > quizmodelArrayList) {
        quizmodelArrayList.add(new quizmodel("0 / 7", "7", "1", "0", "2", "0"));
        quizmodelArrayList.add(new quizmodel("9 / 3", "3", "4", "9", "5", "3"));
        quizmodelArrayList.add(new quizmodel("8 / 4", "4", "3", "2", "8", "2"));
        quizmodelArrayList.add(new quizmodel("14 / 7", "7", "14", "3", "2", "2"));
        quizmodelArrayList.add(new quizmodel("15 / 3 ", "3", "5", "15", "6", "5"));
        quizmodelArrayList.add(new quizmodel("4 / 2", "2", "4", "1", "3", "2"));
        quizmodelArrayList.add(new quizmodel("20 / 4", "10", "4", "5", "7", "5"));
        quizmodelArrayList.add(new quizmodel("7 / 7", "7", "2", "13", "1", "1"));
        quizmodelArrayList.add(new quizmodel("0 / 8", "0", "8", "1", "2", "0"));
        quizmodelArrayList.add(new quizmodel("10 / 2", "2", "5", "10", "6", "5"));
    }
    ...
    {
        Intent i = new Intent(this,ph1completed.class);
        startActivity(i);
    }
